...
The owner's call on the RLDS-priority recommendation: do v2.x first (done above), keep native RLDS on the roadmap but after it — reasoning and the reader-internals design tradeoffs are in DECISIONS.md.
