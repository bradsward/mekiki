...
No code yet — the doc was the whole task, deliberately, per the roadmap's own "don't rush this" instruction for M3. Next: the actual `ActionTarget`/`ActionTargetSpec` types and validation, then the integration math itself.
